    ...
    <section id="home" className="relative w-full py-32 md:py-48">
      <div className="container mx-auto flex flex-col items-center justify-center gap-8 px-4 text-center md:px-6">
        <h2 className="text-xl font-medium text-primary md:text-2xl">
          Flutter Web Developer | <span className="bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">Vibe Coder</span>
        </h2>
        ...
        <div className="group relative my-8">
          ...
          <div className="absolute -bottom-4 -right-4 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 p-3 text-primary-foreground shadow-lg transition-transform duration-500 group-hover:scale-110">
        ...
        <div className="mt-4 flex flex-col items-center gap-4 sm:flex-row">
          <Button asChild size="lg" className="rounded-full font-bold bg-gradient-to-r from-yellow-400 to-orange-500 text-primary-foreground transition-opacity hover:opacity-90">
