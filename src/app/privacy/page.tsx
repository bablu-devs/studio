      ...
      <main className="flex-grow">
        <section className="container mx-auto px-4 md:px-6">
          <div className="prose prose-invert max-w-4xl mx-auto">
            <h1 className="font-headline text-5xl font-extrabold uppercase tracking-wider sm:text-6xl text-primary">Privacy Policy</h1>
            ...
            <h2 className="mt-12 font-headline text-3xl font-bold uppercase tracking-wider text-primary">1. Information We Collect</h2>
            ...
            <h2 className="mt-12 font-headline text-3xl font-bold uppercase tracking-wider text-primary">2. How We Use Information</h2>
            <p className="mt-4 text-lg leading-8 text-foreground/80">
            ...
            <h2 className="mt-12 font-headline text-3xl font-bold uppercase tracking-wider text-primary">3. Sharing Information</h2>
            <p className="mt-4 text-lg leading-8 text-foreground/80">
            ...
            <h2 className="mt-12 font-headline text-3xl font-bold uppercase tracking-wider text-primary">Contact Us</h2>
            <p className="mt-4 text-lg leading-8 text-foreground/80">
